                ...
                >
                  ...
                  <div 
                    className={`transition-all duration-300 ease-in-out overflow-hidden ${
                      isExpanded ? 'max-h-40 border-t border-brand-gray/40' : 'max-h-0'
                    }`}
                  >
                    <p className="px-6 py-5 text-brand-textDark/90 text-sm md:text-base leading-relaxed bg-[#FCF9F6]/50">
                      {item.answer}
                    </p>
                  </div>
                </div>
